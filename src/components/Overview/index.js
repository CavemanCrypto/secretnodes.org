...
<a href="https://blog.enigma.co/secret-nodes-part-2-exploring-eng-economics-and-building-a-sustainable-network-3d0e9f8a9d40"><font color="#E82E9D"> As discussed by enigma here</font></a>, and now finalized, the minimum ENG stake required for a mainnet secret node is 25,000 ENG. This number was selected based on a study of many other networks, internal modeling based on the current distribution of ENG, and balancing a desire for decentralization with network sustainability and having meaningful stakes for node operators. This minimum threshold will however be reduced over the life of the network.
      </TextContainer>
      <TextContainer mediaQueries={props.mediaQueries}>
      <font color="#20B1F9"><b>What are the System Requirements to run a node? </b></font>
       Specialized hardware requirements for Discovery are not substantial. However, running a secret node will require access to an SGX enabled hardware device or an SGX-enabled cloud operator. Any 6th Generation Intel Processor (Skylake) after Q3 of 2015 should have this capability. However, this may or may not be enabled by the BIOS — for example, SGX in Mac computers is not enabled. Currently IBM and Alibaba Cloud do enable SGX instances. For a detailed list of SGX enabled hardware and cloud options, please visit <a href="https://github.com/ayeks/SGX-hardware"><font color="#E82E9D">this link</font></a>. Additionally, <b>we require the use of Linux as an operating system as Windows is not expected to be supported in Discovery.</b>
      </TextContainer>
    </Overview>
  )
}
