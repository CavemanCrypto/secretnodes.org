...
const RewardsSection = props => {
  ...
  return (
    <Rewards id='rewards'>
      ...
      <font color="#20B1F9"><b> How do Block Rewards work?</b></font> Block rewards for the Enigma network will begin at 750,000 ENG for the first year the mainnet is in operation and decrease 10% year-over-year thereafter. The total block rewards pool is thus 7.5M ENG and will not be exhausted for the first century the network is in operation. This pool is 1/5th of the total token pool reserved for network, community, and ecosystem incentives (37.5M ENG). Please keep in mind that the total supply of ENG is fixed at 150M ENG, with 75M ENG already in circulation since 2017 and the vast majority of the remainder is not expected to enter circulation within the next few years.
      </TextContainer>
    </Rewards>
  )
}
